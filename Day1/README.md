...
**Congratulations** for deciding to participate in a **_ Learn Python_** programming  . In this lesson you will learn everything you need to be a python programmer and the whole concepts of programming. 
...
```py
{'name':'Azeez', 'country':'Nigeria', age:250, 'is_married':True}
```
